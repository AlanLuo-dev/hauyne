...
public class CaptchaGrantAuthenticationConverter implements AuthenticationConverter {
    ...
    public Authentication convert(HttpServletRequest request) {
        ...
        if (!OAuth2Constant.GRANT_TYPE_CAPTCHA.equals(grantType)) {
            return null;
        }
        ...
        if (org.apache.commons.lang3.StringUtils.isBlank(requestImgCode)) {
            log.warn("验证码不能为空");
        ...
        return new CaptchaGrantAuthenticationToken(clientPrincipal, additionalParameters);
    }
