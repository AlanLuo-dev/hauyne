...
@OpenAPIDefinition(
        ...
        info = @Info(
                title = "HAUYNE授权服务器 接口文档",       // Api接口文档标题（必填）
                description = "OAUTH2.0 授权API",      // Api接口文档描述
        ...
        servers = {
                @Server(url = "http://localhost:8762/", description = "本地服务器一服务"),
                @Server(url = "http://192.168.3.15:8762/", description = "本地服务器二服务"),
        })
